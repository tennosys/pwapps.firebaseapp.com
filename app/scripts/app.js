...
(function(document) {
  ...
  document.addEventListener('WebComponentsReady', function() {
    ...
    var infoSubscription = document.getElementById('info-subscription');
    ...
    toggle.addEventListener('change', function() {
        if (toggle.checked) {
          console.log(ppm.enable());
        } else {
          console.log(ppm.disable());
        }
      });
    ...
    ppm.addEventListener('enabled-changed', function(event) {
        ...
        console.log('enabled=' + ppm.enabled + '&id=' + previousSubscriptionId);
      });
  })
})(document);
